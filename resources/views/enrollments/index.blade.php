...
<div class="px-4 py-6 sm:px-0">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">A list of all student course enrollments including status, grades, and enrollment dates.</p>
        </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($enrollment->grade)
                                        <div class="text-sm text-gray-900">{{ $enrollment->grade }}%</div>
                                        <div class="text-sm text-gray-500">({{ $enrollment->grade_letter }})</div>
                                    @else
